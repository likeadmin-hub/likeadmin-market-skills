...
existing_slug: m-kling-v3-pro-audio-klingyc
existing_title: "可灵 V3 专业有声（klingYC）"
---

# 可灵 V3 专业有声

视频生成（高画质、带音频）。支持文生视频、图生视频与首尾帧；时长约 3～15 秒。
...
| 类型 | 模型 API |
| 模型名称 | 可灵 V3 专业有声 |
| 模型编码 | `kling-v3-pro-audio` |
| 模型类型 | 视频生成（video） |
| 调用方式 | `POST /api/v1/tasks` |
| 调用模式 | 异步 |
| 计费方式 | 按输入时长（66.500000 元 / 分钟） |
| 最大 token | 1 |
