...
ai_app_api_id: 19
api_code: xhs_note_detail
sync_target: ai_developer_doc
sync_status: pending_review
existing_doc_id: 13
existing_parent_id: 67
existing_slug: watermark-removal-xhs-note-detail
existing_title: "水印消除 · 红薯详情"
---
...
| API 名称 | 红薯详情 |
| API 编码 | `xhs_note_detail` |
| 请求方式 | `POST` |
| 请求路径 | `/api/v1/apps/watermark_removal/xhs_note_detail` |
| 调用模式 | 同步 |
| 计费方式 | 按次（20.0000 元 / 次） |
...
```http
POST /api/v1/apps/watermark_removal/xhs_note_detail
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `noteId` | string | 是 | — | — | `69db4372000000002103a442` | 笔记 ID（与分享链接中 id 一致） |

## 请求示例

```json
{
    "noteId": "69db4372000000002103a442"
}
```
