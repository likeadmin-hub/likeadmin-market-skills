...
ai_app_api_id: 24
api_code: xhs_user_detail
sync_target: ai_developer_doc
sync_status: pending_review
existing_doc_id: 16
existing_parent_id: 67
existing_slug: watermark-removal-xhs-user-detail
existing_title: "水印消除 · 红薯用户"
---
...
| API 名称 | 红薯用户 |
| API 编码 | `xhs_user_detail` |
| 请求方式 | `POST` |
| 请求路径 | `/api/v1/apps/watermark_removal/xhs_user_detail` |
| 调用模式 | 同步 |
| 计费方式 | 按次（20.0000 元 / 次） |
...
```http
POST /api/v1/apps/watermark_removal/xhs_user_detail
```
...
| --- | --- | --- | --- | --- | --- | --- |
| `userId` | string | 是 | — | — | `5aed3d724eacab31d35121d0` | 小红书用户 ID（userid） |

## 请求示例

```json
{
    "userId": "5aed3d724eacab31d35121d0"
}
```
