...
existing_doc_id: 24
existing_parent_id: 66
existing_slug: flashvsr-submit
existing_title: "视频超分 · 提交任务"
---
...
| API 编码 | `submit` |
| 请求方式 | `POST` |
| 请求路径 | `/api/v1/apps/flashvsr/submit` |
| 调用模式 | 异步 |
| 计费方式 | 按输入视频时长（实际价格以当前租户的点数配置为准） |
...
| `input_url` | string | 是 | — | — | `https://example.com/low_res_video.mp4` | 输入视频文件 URL，待超分辨率处理的视频 |
...
{
    "mode": "async_query",
    "input_url": "https://example.com/low_res_video.mp4"
}
```
