...
app_code: seedance
ai_app_api_id: 32
api_code: updateAsset
sync_target: ai_developer_doc
sync_status: pending_review
existing_doc_id: 35
existing_parent_id: 61
existing_slug: seedance-updateasset
existing_title: "Seedance 2.0 · 更新素材"
---
...
| API 编码 | `updateAsset` |
| 请求方式 | `POST` |
| 请求路径 | `/api/v1/apps/seedance/updateAsset` |
| 调用模式 | 同步 |
| 计费方式 | 按次（0.0000 元 / 次） |
...
| --- | --- | --- | --- | --- | --- | --- |
| `Id` | string | 是 | — | — | `asset-20260402224305-54j64` | Asset Id |
